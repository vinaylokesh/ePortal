...
$res2=mysql_query("select id,USN,fname,lname,DOB,gender,address,email,YOJ,username,password,hint from register1");
echo "<table border='2'><tr><th>ID</th><th>USN</th><th>FName</th><th>LName</th><th>DOB</th><th>Gender</th><th>Address</th><th>Email</th><th>YOJ</th><th>username</th><th>Password</th><th>Password Hint</th><th>operation1</th><th>operation2</th></tr>";
$formname=0;
...
echo "<td>$row[11]</td>";
//$inc=$formname++;
echo "<td><a href='deleteregistry.php?id=$arrayid[$inc]'>Delete</a></td>";
echo "<td><a href='addregistery.php?id=$arrayid[$inc]'>Add</a></td></tr>";
}
echo "</table>";
?>
