...
<form action="paintings1.php" method="post"  enctype="multipart/form-data">
...
{
	header("location:paintsearch1.php");
...
if(isset($_FILES['image'])) {
		...
		$fp=addslashes(file_get_contents($_FILES['image']['tmp_name'])); //will store the image 
				...
				// our sql query
				$sql = "INSERT INTO paintings1 VALUES('null', '{$name}','{$description}','{$fp}');";
