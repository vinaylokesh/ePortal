...
$query ="insert into notifications(name,type,message) values('$name','$type','$message');";
...
<li><a href="feedback.php">Feed Back</a>
 ...
 <li><a href="#">Account Settings</a>
    ...
    <div id="site_content">
<center><h1><i>Welcome to Notifications Section</i><h1> </center>
</h3>
<form name="first" action="writenotifications.php" method="post">
 Select Type Of Article: 
<input type="radio" name="art" value="Schedule">Schedule </t>
<input type="radio" name="art" value="Events">Events</t>
<input type="radio" name="art" value="Placement">Placement News</t>
<input type="radio" name="art" value="Others">Others</br>
...
window.alert("Cancel");
	...
	Write Notification </br>
          <textarea class="contact textarea" rows="40" cols="70" name="your_message" required><?php echo $yourmessage;?></textarea>
</br><input name="submit" type="submit" value="submit" onclick="check()">
<span></span>
</form>
</div>
<footer>
