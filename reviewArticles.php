...
$res2=mysql_query("select id,name,date,type,article from articlesref");
echo "<table border='2'><tr><th>ID</th><th>Name</th><th>date</th><th>type</th><th>Article</th><th>operation1</th><th>operation2</th></tr>";
$formname=0;
...
//$inc=$formname++;
echo "<td><a href='deletearticle.php?id=$arrayid[$inc]'>Delete</a></td>";
echo "<td><a href='addarticle.php?id=$arrayid[$inc]'>Add</a></td></tr>";
}
echo "</table>";
?>
