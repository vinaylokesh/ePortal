...
$arrayid[$inc]=$row[0];
			...
			$msg.='<div class="img">';
 			$msg.=  '<a href="paintsearch.php?id='.$id.'"><img src="data:image/jpeg;base64,'.base64_encode($row['image']). ' " width="90%" height="90%" style="display:block;"/>	</a>'  ;
			$msg.='</div>';
...
$msg.= '<a href="deleteuserpaints.php?id='.$arrayid[$inc].'"> Delete  </a>';
$msg.='</br>';

$msg.= '<a href="adduserpaint.php?id='.$arrayid[$inc].'"> Add  </a>';
			$msg.='</div>';
